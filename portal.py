        ...
        if st.button("🚀 GENERATE & PACKAGE ALL PDFs"):
            ...
            if os.path.exists(target_file):
                ...
                if not sc_n:
                    ...
                    # Get Admission List from Column A
                    ...
                    with zipfile.ZipFile(zip_buffer, "w") as zf:
                        ...
                        for index, adm_val in enumerate(adm_list):
                            ...
                            try:
                                ...
                                # Term logic (Defaulting to 3rd Term for full display)
                                term = "3rd Term" 
                    ...
                    try:
                        ...
                        if target_sheet:
                            ...
                            for i, row in df_bulk.iterrows():
                                try:
                                    # Ensure column names match your Excel 'Data' sheet exactly
